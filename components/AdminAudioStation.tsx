...
export default function AdminAudioStation() {
  ...
  return (
    <section className="mx-auto w-full max-w-6xl">
      ...
      <p className="mt-4 max-w-3xl text-white/55">The free Caster.fm player is connected. Switch Live on only after Mixxx is connected and Caster.fm shows On Air.</p>
